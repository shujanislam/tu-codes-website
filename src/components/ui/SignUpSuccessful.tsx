export default function SignUpSuccessfulPopUp() {
  return (
    <div
      role="status"
      aria-live="polite"
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <p className="text-sm font-semibold text-green-900">Sign Up Successful!</p>
          <p className="mt-0.5 text-xs text-green-800">
            You’ve successfully signed up. Please check your mail for the confirmation email.
          </p>
        </div>
